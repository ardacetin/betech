...
$navItemClass = 'group flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium transition';
$navIconClass = 'mr-3 h-5 w-5 shrink-0 text-gray-400 group-hover:text-gray-500';
$sectionHeaderClass = 'mb-2 mt-6 block px-3 text-xs font-semibold uppercase tracking-wider text-gray-400';
...
<nav class="flex-1 p-4">
    ...
    <div class="space-y-1">
        ...
        >
            <svg class="<?= $navIconClass ?>" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
