...
$priorityKey = 'ticket_priority_' . (string) ($ticket['priority'] ?? 'medium');
$priorityLabelValue = function_exists('__') ? __($priorityKey) : (string) ($ticket['priority'] ?? '');
...
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 20px 0;border:1px solid #e4e4e7;border-radius:12px;background-color:#fafafa;">
    <tr>
        <td style="padding:16px 18px;">
            ...
            <p style="margin:0 0 6px 0;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:#71717a;"><?= htmlspecialchars($requesterLabel, ENT_QUOTES, 'UTF-8') ?></p>
            <p style="margin:0 0 16px 0;font-size:15px;line-height:1.5;color:#18181b;"><?= htmlspecialchars((string) ($ticket['personnel_name'] ?? ''), ENT_QUOTES, 'UTF-8') ?></p>

            <p style="margin:0 0 6px 0;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:#71717a;"><?= htmlspecialchars($priorityLabel, ENT_QUOTES, 'UTF-8') ?> / <?= htmlspecialchars($statusLabel, ENT_QUOTES, 'UTF-8') ?></p>
            <p style="margin:0 0 16px 0;font-size:15px;line-height:1.5;color:#18181b;"><?= htmlspecialchars($priorityLabelValue, ENT_QUOTES, 'UTF-8') ?> · <?= htmlspecialchars($statusLabelValue, ENT_QUOTES, 'UTF-8') ?></p>

            <p style="margin:0 0 6px 0;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:#71717a;"><?= htmlspecialchars($descriptionLabel, ENT_QUOTES, 'UTF-8') ?></p>
            <p style="margin:0;font-size:14px;line-height:1.6;color:#3f3f46;white-space:pre-wrap;"><?= htmlspecialchars((string) ($ticket['description'] ?? ''), ENT_QUOTES, 'UTF-8') ?></p>
        </td>
    </tr>
</table>
