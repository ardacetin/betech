...
class DatabaseInitializer
{
    ...
    public function initialize(): DatabaseInitializationResult
    {
        ...
        try {
            ...
            if ($this->assetsTableExists($connection)) {
                ...
                foreach ($this->patchAnnouncementsAndPublicDocuments($connection) as $warning) {
                    $warnings[] = $warning;
                }
     ...
     * @return list<string>
     */
    private function patchAnnouncementsAndPublicDocuments(object $connection): array
    {
        $warnings = [];
        ...
        if (!$this->tableExists($connection, 'announcements')) {
            $connection->query(
            ...
            $warnings[] = 'Self-healed database: created announcements table.';
        }
        ...
        if ($this->tableExists($connection, 'quality_documents')
            ...
            $warnings[] = 'Self-healed database: added quality_documents.is_public column.';
        }
