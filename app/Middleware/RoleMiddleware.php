...
class RoleMiddleware implements MiddlewareInterface
{
    ...
    public static function defaultRules(): array
    {
        ...
        return [
            ...
            [
                'methods' => ['GET'],
                'pattern' => '/api/ip-networks/export',
                'roles' => $operational,
            ],
            [
                'methods' => ['GET'],
            ...
            [
                'methods' => ['GET'],
                'pattern' => '/api/network/switches',
                'roles' => $operational,
            ],
            [
                'methods' => ['GET'],
                'pattern' => '/api/network/switches/directory',
                'roles' => $operational,
            ],
            [
                'methods' => ['GET'],
                'pattern' => '/api/network/switches/matrix',
                'roles' => $operational,
            ],
            [
                'methods' => ['GET'],
                'pattern' => '/api/network/port-mappings',
                'roles' => $operational,
            ],
            [
                'methods' => ['GET'],
                'pattern' => '/api/network/port-mappings/search',
                'roles' => $operational,
            ],
            [
                'methods' => ['POST'],
            ...
            [
                'methods' => ['POST'],
                'pattern' => '/api/network/port-mappings/disconnect',
                'roles' => $operational,
            ],
            [
                'methods' => ['GET'],
